    ...
    <div class="contact__container">
        ...
        <div class="contact__wrapper">
            <form action="-" method="post" class="contact__form forms">
                ...
                <input class="forms__name-input" type="text" name="name" id="name" required>
                ...
                <textarea class="forms__message-input" name="message" id="message" rows="5" required></textarea>
